...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GBObject.login_required'
        db.add_column('objectapp_gbobject', 'login_required', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'GBObject.password'
        db.add_column('objectapp_gbobject', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'GBObject.login_required'
        db.delete_column('objectapp_gbobject', 'login_required')

        # Deleting field 'GBObject.password'
        db.delete_column('objectapp_gbobject', 'password')
