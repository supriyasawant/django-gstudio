...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GBObject.template'
        db.add_column('objectapp_gbobject', 'template', self.gf('django.db.models.fields.CharField')(default='objectapp/gbobject_detail.html', max_length=250), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'GBObject.template'
        db.delete_column('objectapp_gbobject', 'template')
