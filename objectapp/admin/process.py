...
class ProcessAdmin(reversion.VersionAdmin):
    ...
    # fieldsets = ((_('Attribute Definiton'), {'fields': ('title','altnames','processtypes','priorstate_attribute_set','priorstate_relation_set','poststate_attribute_set','poststate_relation_set','parent','slug','status') }),
