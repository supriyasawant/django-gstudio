"""Moderator of Relationapp comments"""
...
from relationapp.settings import MAIL_COMMENT_REPLY
from relationapp.settings import MAIL_COMMENT_AUTHORS
from relationapp.settings import AUTO_MODERATE_COMMENTS
from relationapp.settings import AUTO_CLOSE_COMMENTS_AFTER
from relationapp.settings import MAIL_COMMENT_NOTIFICATION_RECIPIENTS
from relationapp.settings import SPAM_CHECKER_BACKENDS
from relationapp.spam_checker import check_is_spam


class RelationtypeCommentModerator(CommentModerator):
    """Moderate the comment of Relationtype"""
    ...
    def do_email_authors(self, comment, content_object, request):
        ...
        relationtype when email notifications have been requested."""
