...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationtype.login_required'
        db.add_column('relationapp_relationtype', 'login_required', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Relationtype.password'
        db.add_column('relationapp_relationtype', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Relationtype.login_required'
        db.delete_column('relationapp_relationtype', 'login_required')

        # Deleting field 'Relationtype.password'
        db.delete_column('relationapp_relationtype', 'password')
