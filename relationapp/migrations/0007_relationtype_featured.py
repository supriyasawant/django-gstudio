...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationtype.featured'
        db.add_column('relationapp_relationtype', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Relationtype.featured'
        db.delete_column('relationapp_relationtype', 'featured')
