...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationtype.pingback_enabled'
        db.add_column('relationapp_relationtype', 'pingback_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Relationtype.pingback_enabled'
        db.delete_column('relationapp_relationtype', 'pingback_enabled')
