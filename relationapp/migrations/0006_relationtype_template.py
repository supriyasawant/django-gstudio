...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationtype.template'
        db.add_column('relationapp_relationtype', 'template', self.gf('django.db.models.fields.CharField')(default='relationapp/relationtype_detail.html', max_length=250), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Relationtype.template'
        db.delete_column('relationapp_relationtype', 'template')
