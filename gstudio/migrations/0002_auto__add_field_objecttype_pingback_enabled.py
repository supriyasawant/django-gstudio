...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objecttype.pingback_enabled'
        db.add_column('gstudio_objecttype', 'pingback_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Objecttype.pingback_enabled'
        db.delete_column('gstudio_objecttype', 'pingback_enabled')
