...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objecttype.template'
        db.add_column('gstudio_objecttype', 'template', self.gf('django.db.models.fields.CharField')(default='gstudio/objecttype_detail.html', max_length=250), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Objecttype.template'
        db.delete_column('gstudio_objecttype', 'template')
