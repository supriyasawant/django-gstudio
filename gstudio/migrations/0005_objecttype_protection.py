...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objecttype.login_required'
        db.add_column('gstudio_objecttype', 'login_required', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Objecttype.password'
        db.add_column('gstudio_objecttype', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Objecttype.login_required'
        db.delete_column('gstudio_objecttype', 'login_required')

        # Deleting field 'Objecttype.password'
        db.delete_column('gstudio_objecttype', 'password')
