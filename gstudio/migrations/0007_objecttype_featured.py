...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objecttype.featured'
        db.add_column('gstudio_objecttype', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Objecttype.featured'
        db.delete_column('gstudio_objecttype', 'featured')
