...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RandomObjecttypesPlugin'
        db.create_table('cmsplugin_randomobjecttypesplugin', (
        ...
        db.send_create_signal('plugins', ['RandomObjecttypesPlugin'])

    def backwards(self, orm):

        # Deleting model 'RandomObjecttypesPlugin'
        db.delete_table('cmsplugin_randomobjecttypesplugin')
    ...
    models = {
        ...
        'plugins.latestobjecttypesplugin': {
            ...
            'submetatypes': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'plugins.randomobjecttypesplugin': {
            'Meta': {'object_name': 'RandomObjecttypesPlugin', 'db_table': "'cmsplugin_randomobjecttypesplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'number_of_objecttypes': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'template_to_render': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        ...
        'gstudio.metatype': {
            'Meta': {'ordering': "['title']", 'object_name': 'Metatype'},
        ...
        'gstudio.objecttype': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'Objecttype'},
            ...
            'template': ('django.db.models.fields.CharField', [], {'default': "'gstudio/objecttype_detail.html'", 'max_length': '250'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
