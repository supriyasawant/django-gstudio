...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestObjecttypesPlugin.template_to_render'
        db.add_column('cmsplugin_latestobjecttypesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='gstudio/cms/objecttype_list.html', max_length=250, blank=True), keep_default=False)

        # Adding field 'SelectedObjecttypesPlugin.template_to_render'
        db.add_column('cmsplugin_selectedobjecttypesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='gstudio/cms/objecttype_list.html', max_length=250, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LatestObjecttypesPlugin.template_to_render'
        db.delete_column('cmsplugin_latestobjecttypesplugin', 'template_to_render')

        # Deleting field 'SelectedObjecttypesPlugin.template_to_render'
        db.delete_column('cmsplugin_selectedobjecttypesplugin', 'template_to_render')
