...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestObjecttypesPlugin.submetatypes'
        db.add_column('cmsplugin_latestobjecttypesplugin', 'submetatypes', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LatestObjecttypesPlugin.submetatypes'
        db.delete_column('cmsplugin_latestobjecttypesplugin', 'submetatypes')
