...
from gstudio.tests.objecttype import ObjecttypeTestCase  # ~0.2s
from gstudio.tests.objecttype import ObjecttypeHtmlContentTestCase  # ~0.5s
from gstudio.tests.objecttype import ObjecttypeGetBaseModelTestCase
from gstudio.tests.signals import SignalsTestCase
from gstudio.tests.metatype import MetatypeTestCase
from gstudio.tests.admin import ObjecttypeAdminTestCase
...
from gstudio.tests.quick_objecttype import QuickObjecttypeTestCase  # ~0.4s
...
from gstudio.tests.moderator import ObjecttypeCommentModeratorTestCase  # ~0.1s
...
def suite():
    ...
    test_cases = (ManagersTestCase, ObjecttypeTestCase,
                  ObjecttypeGetBaseModelTestCase, SignalsTestCase,
                  ObjecttypeHtmlContentTestCase, MetatypeTestCase,
                  ...
                  TemplateTagsTestCase, QuickObjecttypeTestCase,
                  URLShortenerTestCase, ObjecttypeCommentModeratorTestCase,
                  GstudioCustomDetailViews, SpamCheckerTestCase,
                  ObjecttypeAdminTestCase, MetatypeAdminTestCase)
