...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attributetype.login_required'
        db.add_column('attributeapp_attributetype', 'login_required', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Attributetype.password'
        db.add_column('attributeapp_attributetype', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Attributetype.login_required'
        db.delete_column('attributeapp_attributetype', 'login_required')

        # Deleting field 'Attributetype.password'
        db.delete_column('attributeapp_attributetype', 'password')
