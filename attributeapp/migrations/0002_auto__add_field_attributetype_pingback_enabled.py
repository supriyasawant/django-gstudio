...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attributetype.pingback_enabled'
        db.add_column('attributeapp_attributetype', 'pingback_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Attributetype.pingback_enabled'
        db.delete_column('attributeapp_attributetype', 'pingback_enabled')
