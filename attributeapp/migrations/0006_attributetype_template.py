...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attributetype.template'
        db.add_column('attributeapp_attributetype', 'template', self.gf('django.db.models.fields.CharField')(default='attributeapp/attributetype_detail.html', max_length=250), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Attributetype.template'
        db.delete_column('attributeapp_attributetype', 'template')
