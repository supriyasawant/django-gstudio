...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attributetype.featured'
        db.add_column('attributeapp_attributetype', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Attributetype.featured'
        db.delete_column('attributeapp_attributetype', 'featured')
