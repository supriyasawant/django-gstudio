"""Test cases for Attributeapp's ping"""
import cStringIO
...
from attributeapp.ping import URLRessources
...
class DirectoryPingerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.pinger = DirectoryPinger('http://localhost', [self.attributetype],
                                      start_now=False)

    def test_ping_attributetype(self):
        self.assertEquals(
            self.pinger.ping_attributetype(self.attributetype),
...
class ExternalUrlsPingerTestCase(TestCase):
    ...
    def setUp(self):
        params = {'title': 'My attributetype',
                  ...
                  'slug': 'my-attributetype'}
        self.attributetype = Attributetype.objects.create(**params)
        self.pinger = ExternalUrlsPinger(self.attributetype, start_now=False)
    ...
    def test_find_external_urls(self):
        r = URLRessources()
        external_urls = self.pinger.find_external_urls(self.attributetype)
        self.assertEquals(external_urls, [])
        self.attributetype.content = """
    ...
    def test_find_pingback_urls(self):
        ...
        self.original_urlopen = attributeapp.ping.urlopen
        attributeapp.ping.urlopen = self.fake_urlopen
        ...
        # Remove stub
        attributeapp.ping.urlopen = self.original_urlopen
