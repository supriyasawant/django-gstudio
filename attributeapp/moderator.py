"""Moderator of Attributeapp comments"""
...
from attributeapp.settings import MAIL_COMMENT_REPLY
from attributeapp.settings import MAIL_COMMENT_AUTHORS
from attributeapp.settings import AUTO_MODERATE_COMMENTS
from attributeapp.settings import AUTO_CLOSE_COMMENTS_AFTER
from attributeapp.settings import MAIL_COMMENT_NOTIFICATION_RECIPIENTS
from attributeapp.settings import SPAM_CHECKER_BACKENDS
from attributeapp.spam_checker import check_is_spam


class AttributetypeCommentModerator(CommentModerator):
    """Moderate the comment of Attributetype"""
    ...
    def do_email_authors(self, comment, content_object, request):
        ...
        attributetype when email notifications have been requested."""
