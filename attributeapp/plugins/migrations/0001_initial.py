...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LatestAttributetypesPlugin'
        db.create_table('cmsplugin_latestattributetypesplugin', (
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attributeapp.Attribute'], null=True, blank=True)),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('number_of_attributetypes', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('plugins', ['LatestAttributetypesPlugin'])

        # Adding model 'SelectedAttributetypesPlugin'
        db.create_table('cmsplugin_selectedattributetypesplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('plugins', ['SelectedAttributetypesPlugin'])

        # Adding M2M table for field attributetypes on 'SelectedAttributetypesPlugin'
        db.create_table('plugins_selectedattributetypesplugin_attributetypes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('selectedattributetypesplugin', models.ForeignKey(orm['plugins.selectedattributetypesplugin'], null=False)),
            ('attributetype', models.ForeignKey(orm['attributeapp.attributetype'], null=False))
        ))
        db.create_unique('plugins_selectedattributetypesplugin_attributetypes', ['selectedattributetypesplugin_id', 'attributetype_id'])

    def backwards(self, orm):

        # Deleting model 'LatestAttributetypesPlugin'
        db.delete_table('cmsplugin_latestattributetypesplugin')

        # Deleting model 'SelectedAttributetypesPlugin'
        db.delete_table('cmsplugin_selectedattributetypesplugin')

        # Removing M2M table for field attributetypes on 'SelectedAttributetypesPlugin'
        db.delete_table('plugins_selectedattributetypesplugin_attributetypes')
    ...
    models = {
        ...
        'plugins.latestattributetypesplugin': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['attributeapp.Attribute']", 'null': 'True', 'blank': 'True'}),
