...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RandomAttributetypesPlugin'
        db.create_table('cmsplugin_randomattributetypesplugin', (
        ...
        db.send_create_signal('plugins', ['RandomAttributetypesPlugin'])

    def backwards(self, orm):

        # Deleting model 'RandomAttributetypesPlugin'
        db.delete_table('cmsplugin_randomattributetypesplugin')
    ...
    models = {
        ...
        'plugins.latestattributetypesplugin': {
            ...
            'subattributes': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'plugins.randomattributetypesplugin': {
            'Meta': {'object_name': 'RandomAttributetypesPlugin', 'db_table': "'cmsplugin_randomattributetypesplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'number_of_attributetypes': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'template_to_render': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        ...
        'attributeapp.attribute': {
            'Meta': {'ordering': "['title']", 'object_name': 'Attribute'},
        ...
        'attributeapp.attributetype': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'Attributetype'},
            ...
            'template': ('django.db.models.fields.CharField', [], {'default': "'attributeapp/attributetype_detail.html'", 'max_length': '250'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
