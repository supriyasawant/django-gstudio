...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestAttributetypesPlugin.subattributes'
        db.add_column('cmsplugin_latestattributetypesplugin', 'subattributes', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LatestAttributetypesPlugin.subattributes'
        db.delete_column('cmsplugin_latestattributetypesplugin', 'subattributes')
